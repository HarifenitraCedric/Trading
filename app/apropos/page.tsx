...
const containerVariants = {
  ...
  return (
  <>
  <div className="w-screen h-screen bg-[#5686FE] flex items-center justify-center overflow-hidden font-sans">
  {/* Rectangle principal */}
 <div 
  className="relative w-full max-w-7xl h-[90vh] border-2 border-[#8DABED] rounded-3xl p-6 lg:p-10
...
>
  ...
  variants={itemVariants}>
        ...
        <motion.p className="text-white-400 max-w-md mb-6">
