...
const HelpPage = () => {
  return (
    ...
    <div className="flex-1  text-gray-300">
      <section className="bg-white dark:bg-[#142636] rounded-xl p-6 shadow-md transition-colors duration-300 mb-6">
        <h2 className="text-2xl font-bold text-gray-700 dark:text-white mb-4 border-b border-gray-700 pb-2">Centre d'aide et de support</h2>
        <div className="space-y-6">
          <div className="bg-[#5686FE]/20 dark:bg-[#203445] p-4 rounded-lg">
            ...
            <a href="#" className="text-[#5686FE] hover:underline mt-2 inline-block font-medium">
              Voir toutes les FAQ
          ...
          <div className="bg-[#5686FE]/20 dark:bg-[#203445] p-4 rounded-lg">
            <h3 className="text-xl font-semibold text-[#5686FE] flex items-center mb-2">
              <span className=" text-gray-700 dark:text-white mr-2 text-2xl">📞</span>
            ...
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 mt-4">
              <a href="#" className="flex items-center justify-center p-3 rounded-md bg-[#5686FE] text-white font-semibold hover:bg-green-600 transition-colors">
                <span className="mr-2">📧</span>Envoyer un email
              </a>
              <a href="#" className="flex items-center justify-center p-3 rounded-md border border-[#5686FE] text-[#5686FE] font-semibold hover:bg-[#5686FE]/70 hover:text-white transition-colors">
